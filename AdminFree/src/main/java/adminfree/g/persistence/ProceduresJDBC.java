...
public class ProceduresJDBC {
	...
	private static final String PACK_CONFIGURACIONES_PR_ELIMINAR_CLIENTE = "{call PACK_CONFIGURACIONES.PR_ELIMINAR_CLIENTE(?,?)}";
	 ...
	 * @return 200 si todo es OK, de lo contrario se retorna la descripcion del ERROR
	 */
	public String eliminarCliente(Long idCliente, Connection con) throws Exception {
		...
		try {
			...
			callStatement = con.prepareCall(PACK_CONFIGURACIONES_PR_ELIMINAR_CLIENTE);
